...
- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/simulation/figure6_spiral_particles.npz`
- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/simulation/figure6_spiral_metrics.csv`
- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/simulation/locality_spiral_metrics.csv`
- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/simulation/figure6_metadata.json`
- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/simulation/locality_spiral_metadata.json`
- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/simulation/arm_modes/spiral_arm_mode_comparison.csv`
- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/simulation/arm_modes/spiral_arm_mode_comparison.json`
- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/simulation/arm_modes/spiral_arm_mode_comparison.png`
- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/simulation/arm_modes/spiral_arm_mode_comparison_report.md`

Animation outputs:

- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/animation/spiral_galaxy_formation_2d.mp4`
- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/animation/spiral_galaxy_formation_2d_frame_strip.png`
- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/animation/spiral_galaxy_formation_3d.mp4`
- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/animation/spiral_galaxy_formation_3d_frame_strip.png`
- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/animation/spiral_galaxy_formation_2d_arm_mode_3.mp4`
- `the_nothingness_effect/gravitational_cosmological_and_quantum_dynamics_architecture/locality_driven_gravity/animation/spiral_galaxy_formation_3d_arm_mode_mixed.mp4`
