...
def contracts() -> tuple[ComplexContract, ...]:
    ...
    artifact = ArtifactSpec(("residual_table", "prime_graph", "source_removal_comparison"), "python -m equations.artificial_intelligence.pgqenn.simulation.run_contract_suite")
