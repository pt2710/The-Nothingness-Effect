...
def contracts() -> tuple[ComplexContract, ...]:
    ...
    artifact = ArtifactSpec(("residual_table", "closure_field", "source_removal_comparison"), "python -m equations.artificial_intelligence.qenn.simulation.run_contract_suite")
