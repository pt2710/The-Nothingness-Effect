...
def contracts() -> tuple[ComplexContract, ...]:
    ...
    artifact = ArtifactSpec(("residual_table", "modality_closure_field", "source_removal_comparison"), "python -m equations.artificial_intelligence.soinets.simulation.run_contract_suite")
