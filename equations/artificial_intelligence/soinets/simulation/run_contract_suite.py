...
from equations.artificial_intelligence.soinets.contracts import APPENDIX, APPENDIX_SHA256, SOInetContractInput, contracts
    ...
    for contract, evaluation in evaluations:
        ...
        manifests.append(write_artifact_manifest(
            ...
            build_manifest(
                ...
                regeneration_command=f"python -m equations.artificial_intelligence.soinets.simulation.run_contract_suite --output {output.as_posix()}",
            ),
        ))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=Path, default=Path("artifacts/artificial_intelligence/soinets"))
