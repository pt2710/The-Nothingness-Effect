...
from equations.artificial_intelligence.pgqenn.model import PGQENNModel, PGQENNOutput
from equations.artificial_intelligence.qenn.model import QENNModel, QENNOutput
