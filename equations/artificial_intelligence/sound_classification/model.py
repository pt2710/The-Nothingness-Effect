...
from equations.artificial_intelligence.shared.capability_fixtures import SOUND_LABELS, SOUND_PROTOTYPE_FREQUENCIES
from equations.artificial_intelligence.shared.capability_runtime import ClassificationOutput, TNEPrototypeClassifier
