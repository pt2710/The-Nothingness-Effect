...
```text
equations/completeness_theorem/
  README.md
  models.py
  simulation/
    __init__.py
...
```bash
python -m equations.completeness_theorem.simulation.run_godel_boundary_figures
python -m equations.completeness_theorem.simulation.run_completeness_supplementary
```

Run the focused tests with:

```bash
python -m pytest equations/completeness_theorem/tests
```
...
```text
equations/completeness_theorem/supplementary/
```
