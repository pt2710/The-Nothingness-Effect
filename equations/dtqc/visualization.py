...
from equations.gravitational_cosmological_quantum_dynamics.contract_artifacts import fixture
    ...
    *,
    ...
    manifest = write_metadata(
        output / f"dtqc_{mode}_visualization_manifest.json",
        {
            ...
            "regeneration_command": f"python -m equations.dtqc.{mode}.run_evidence",
