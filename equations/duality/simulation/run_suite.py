        ...
        manifests.append(
            write_artifact_manifest(
                ...
                build_manifest(
                    ...
                    regeneration_command=f"python -m equations.duality.simulation --output {output.as_posix()}",
                ),
            )
        )
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=Path("artifacts/duality"))
