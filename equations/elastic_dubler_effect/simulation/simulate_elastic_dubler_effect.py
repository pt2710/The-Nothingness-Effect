...
def run(output_dir: str | Path | None = None, quick: bool = False) -> dict[str, Path | bool]:
    ...
    write_metadata(
        metadata_path,
        {
            ...
            "script": "equations.elastic_dubler_effect.simulation.simulate_elastic_dubler_effect",
            "equations_module": "equations.elastic_dubler_effect.elastic_dubler_effect",
