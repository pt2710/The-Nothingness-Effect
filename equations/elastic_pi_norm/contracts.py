...
def contracts() -> tuple[ComplexContract, ...]:
    ...
    artifact = ArtifactSpec(("weighted_path_csv", "bounds_plot", "source_removal_table"), "python -m equations.elastic_pi_norm.simulation.run_contract_suite")
    result = [
        ComplexContract(A_IDS[0], APPENDIX, APPENDIX_SHA256, ComplexLevel.A, (), domain, CodomainSpec("weighted path", "norm on anchored domain or seminorm with explicit status", (ElasticPiNormResult,)), path_operator, implementation_path="equations/elastic_pi_norm/contracts.py"),
        ComplexContract(A_IDS[1], APPENDIX, APPENDIX_SHA256, ComplexLevel.A, (), domain, CodomainSpec("weight regularity", "positive Elastic-pi field ratios", (WeightRegularity,)), weight_operator, residual=lambda _s, o: _residual("field ratio identity", o.ratio_residual), implementation_path="equations/elastic_pi_norm/contracts.py"),
        ComplexContract(A_IDS[2], APPENDIX, APPENDIX_SHA256, ComplexLevel.A, (), domain, CodomainSpec("reweighting bounds", "lower and upper path bounds", (ReweightingBounds,)), bounds_operator, residual=lambda _s, o: _residual("reweighting bounds", o.bound_residual), implementation_path="equations/elastic_pi_norm/contracts.py"),
        ComplexContract(A_IDS[3], APPENDIX, APPENDIX_SHA256, ComplexLevel.A, (), domain, CodomainSpec("pDFI norm interface", "common-input calibrated residual", (PdfiNormInterface,)), interface_operator, residual=lambda _s, o: _residual("pDFI norm interface", (o.residual,)), implementation_path="equations/elastic_pi_norm/contracts.py"),
        ComplexContract(A_IDS[4], APPENDIX, APPENDIX_SHA256, ComplexLevel.A, (), domain, CodomainSpec("pDFI norm equivalence", "conditional calibrated status", (PdfiNormEquivalence,)), equivalence_operator, residual=lambda _s, o: _residual("pDFI norm decoupling", (o.decoupling_residual,)), implementation_path="equations/elastic_pi_norm/contracts.py"),
        ComplexContract(B_IDS[0], APPENDIX, APPENDIX_SHA256, ComplexLevel.B, (A_IDS[0], A_IDS[1]), domain, CodomainSpec("path ratio regularity", "genuine path-weight interaction", (PathRatioRegularity,)), ratio_regularity_operator, residual=lambda _s, o: _residual("weight ratio", o.ratio_residual), source_removal_checks=(remove_path, remove_ratio), artifact_spec=artifact, implementation_path="equations/elastic_pi_norm/contracts.py"),
        ComplexContract(B_IDS[1], APPENDIX, APPENDIX_SHA256, ComplexLevel.B, (A_IDS[2], A_IDS[3], A_IDS[4]), domain, CodomainSpec("entropy pDFI calibration", "genuine bounds-interface-equivalence interaction", (EntropyPdfiCalibration,)), calibration_operator, residual=lambda _s, o: _residual("entropy pDFI calibration", o.residual), source_removal_checks=(remove_bounds, remove_interface, remove_equivalence), artifact_spec=artifact, implementation_path="equations/elastic_pi_norm/contracts.py"),
        ComplexContract(C_ID, APPENDIX, APPENDIX_SHA256, ComplexLevel.C, B_IDS, domain, CodomainSpec("spatial weighted calibration", "local operator, boundary trace, coercivity, and candidate status", (SpatialWeightedClosure,)), spatial_operator, residual=lambda _s, o: _residual("spatial weighted calibration", (o.calibration_residual,)), closure_predicate=lambda output, residual: output.closure_status == "numerical_candidate" and output.coercivity_ratio > 0.0 and residual is not None and residual.passed, source_removal_checks=(remove_regularity, remove_calibration), artifact_spec=artifact, exact_semantics=False, implementation_path="equations/elastic_pi_norm/contracts.py"),
    ]
    return tuple(result)
