"""Test bidirectional sound classification and generate evidence under this test module's artifacts directory."""
...
def test_non_finite_sound_fails_closed() -> None:
    with pytest.raises(AIObstructionError):
        BidirectionalSoundClassifier()(torch.full((1, 256), float("inf")))
