"""Test color classification and generate evidence under this test module's artifacts directory."""
...
def test_non_finite_color_fails_closed() -> None:
    with pytest.raises(AIObstructionError):
        ColorClassifier()(torch.full((1, 4, 4, 3), float("nan")))
