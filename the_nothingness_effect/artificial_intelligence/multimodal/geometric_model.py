"""Geometry-aware TNE multimodal model over the canonical trainable backbone."""
...
class TNEGeometricMultimodalModel(TNETrainableMultimodalModel):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            axis_dim=axis_dim,
            local_rbm_hidden=local_rbm_hidden,
