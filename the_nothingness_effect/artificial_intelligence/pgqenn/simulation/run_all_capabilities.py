"""Simulate PGQENN across every required visual and auditory output group."""
...
def run_all(output_dir: str | Path | None = None, *, seed: int = 0):
    ...
    return run_architecture_capability_suite("pgqenn", PGQENNModel, output, seed=seed, simulation=True)
