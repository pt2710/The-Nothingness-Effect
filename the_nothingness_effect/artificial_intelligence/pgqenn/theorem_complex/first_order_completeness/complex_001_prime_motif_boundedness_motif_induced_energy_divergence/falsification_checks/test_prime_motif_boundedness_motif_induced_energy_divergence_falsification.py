"""Fail-closed falsification metadata check for prime_motif_boundedness_motif_induced_energy_divergence."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'prime_motif_boundedness_motif_induced_energy_divergence'
