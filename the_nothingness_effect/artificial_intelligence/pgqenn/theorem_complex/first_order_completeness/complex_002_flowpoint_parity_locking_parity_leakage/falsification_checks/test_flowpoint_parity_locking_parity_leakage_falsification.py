"""Fail-closed falsification metadata check for flowpoint_parity_locking_parity_leakage."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'flowpoint_parity_locking_parity_leakage'
