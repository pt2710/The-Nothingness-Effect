"""Fail-closed falsification metadata check for dfi_plateau_for_pgqenn_dfi_divergence_spiking_under_motif_bias."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dfi_plateau_for_pgqenn_dfi_divergence_spiking_under_motif_bias'
