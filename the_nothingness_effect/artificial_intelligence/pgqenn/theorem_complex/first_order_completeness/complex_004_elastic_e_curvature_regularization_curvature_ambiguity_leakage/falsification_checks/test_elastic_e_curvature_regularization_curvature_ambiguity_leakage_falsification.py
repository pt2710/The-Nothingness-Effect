"""Fail-closed falsification metadata check for elastic_e_curvature_regularization_curvature_ambiguity_leakage."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_e_curvature_regularization_curvature_ambiguity_leakage'
