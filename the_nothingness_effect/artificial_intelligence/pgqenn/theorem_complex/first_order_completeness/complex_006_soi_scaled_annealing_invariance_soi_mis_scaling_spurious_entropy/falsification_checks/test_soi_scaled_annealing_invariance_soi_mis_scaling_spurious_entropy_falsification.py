"""Fail-closed falsification metadata check for soi_scaled_annealing_invariance_soi_mis_scaling_spurious_entropy."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'soi_scaled_annealing_invariance_soi_mis_scaling_spurious_entropy'
