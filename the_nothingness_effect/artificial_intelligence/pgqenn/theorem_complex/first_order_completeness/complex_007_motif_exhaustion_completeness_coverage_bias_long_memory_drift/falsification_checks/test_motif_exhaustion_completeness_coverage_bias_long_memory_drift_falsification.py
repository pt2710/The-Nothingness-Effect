"""Fail-closed falsification metadata check for motif_exhaustion_completeness_coverage_bias_long_memory_drift."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'motif_exhaustion_completeness_coverage_bias_long_memory_drift'
