"""Fail-closed falsification metadata check for weight_energy_parseval_equivalence_layerwise_l_2_energy_mismatch."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'weight_energy_parseval_equivalence_layerwise_l_2_energy_mismatch'
