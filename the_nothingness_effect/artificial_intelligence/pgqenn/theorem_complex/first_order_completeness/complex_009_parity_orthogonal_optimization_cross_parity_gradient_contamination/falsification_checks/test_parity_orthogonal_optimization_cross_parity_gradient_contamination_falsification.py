"""Fail-closed falsification metadata check for parity_orthogonal_optimization_cross_parity_gradient_contamination."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'parity_orthogonal_optimization_cross_parity_gradient_contamination'
