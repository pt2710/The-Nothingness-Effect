"""Fail-closed falsification metadata check for prime_shell_growth_regularity_shell_instability_phase_slips."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'prime_shell_growth_regularity_shell_instability_phase_slips'
