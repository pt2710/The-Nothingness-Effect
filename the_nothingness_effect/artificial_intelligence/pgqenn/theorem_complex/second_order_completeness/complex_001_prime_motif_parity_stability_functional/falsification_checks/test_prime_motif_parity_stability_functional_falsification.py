"""Fail-closed falsification metadata check for prime_motif_parity_stability_functional."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'prime_motif_parity_stability_functional'
