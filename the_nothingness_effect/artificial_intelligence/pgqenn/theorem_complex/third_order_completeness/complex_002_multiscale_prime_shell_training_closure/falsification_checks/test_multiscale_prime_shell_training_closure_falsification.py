"""Fail-closed falsification metadata check for multiscale_prime_shell_training_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'multiscale_prime_shell_training_closure'
