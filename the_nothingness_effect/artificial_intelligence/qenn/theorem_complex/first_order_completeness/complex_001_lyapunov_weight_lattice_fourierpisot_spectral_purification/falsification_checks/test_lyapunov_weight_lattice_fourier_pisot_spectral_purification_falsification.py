"""Fail-closed falsification metadata check for lyapunov_weight_lattice_fourier_pisot_spectral_purification."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'lyapunov_weight_lattice_fourier_pisot_spectral_purification'
