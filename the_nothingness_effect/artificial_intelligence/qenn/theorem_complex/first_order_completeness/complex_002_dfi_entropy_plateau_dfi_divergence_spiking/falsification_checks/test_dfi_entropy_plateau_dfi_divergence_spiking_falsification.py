"""Fail-closed falsification metadata check for dfi_entropy_plateau_dfi_divergence_spiking."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dfi_entropy_plateau_dfi_divergence_spiking'
