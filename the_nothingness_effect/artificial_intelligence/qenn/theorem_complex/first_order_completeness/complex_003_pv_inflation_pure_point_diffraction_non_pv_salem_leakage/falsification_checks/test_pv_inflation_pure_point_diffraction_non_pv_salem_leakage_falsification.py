"""Fail-closed falsification metadata check for pv_inflation_pure_point_diffraction_non_pv_salem_leakage."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'pv_inflation_pure_point_diffraction_non_pv_salem_leakage'
