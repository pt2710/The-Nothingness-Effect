"""Fail-closed falsification metadata check for parseval_energy_bijection_for_epochs_energy_mass_imbalance."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'parseval_energy_bijection_for_epochs_energy_mass_imbalance'
