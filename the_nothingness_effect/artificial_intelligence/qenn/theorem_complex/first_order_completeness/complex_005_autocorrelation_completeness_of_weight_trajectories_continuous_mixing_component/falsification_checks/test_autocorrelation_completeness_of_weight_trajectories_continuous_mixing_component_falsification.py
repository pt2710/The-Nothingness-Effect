"""Fail-closed falsification metadata check for autocorrelation_completeness_of_weight_trajectories_continuous_mixing_component."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'autocorrelation_completeness_of_weight_trajectories_continuous_mixing_component'
