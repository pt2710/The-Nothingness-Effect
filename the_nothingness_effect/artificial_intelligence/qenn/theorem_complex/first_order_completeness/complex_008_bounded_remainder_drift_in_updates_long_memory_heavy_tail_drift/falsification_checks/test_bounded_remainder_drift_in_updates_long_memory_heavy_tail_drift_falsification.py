"""Fail-closed falsification metadata check for bounded_remainder_drift_in_updates_long_memory_heavy_tail_drift."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'bounded_remainder_drift_in_updates_long_memory_heavy_tail_drift'
