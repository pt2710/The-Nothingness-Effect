"""Fail-closed falsification metadata check for inflation_collapse_support_invariance_nonlinear_sideband_mixing."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'inflation_collapse_support_invariance_nonlinear_sideband_mixing'
