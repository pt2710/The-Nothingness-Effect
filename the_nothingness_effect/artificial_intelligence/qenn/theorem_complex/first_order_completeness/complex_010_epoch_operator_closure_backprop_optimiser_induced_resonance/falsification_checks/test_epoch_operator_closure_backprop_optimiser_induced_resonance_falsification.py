"""Fail-closed falsification metadata check for epoch_operator_closure_backprop_optimiser_induced_resonance."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'epoch_operator_closure_backprop_optimiser_induced_resonance'
