"""Fail-closed falsification metadata check for hyper_parameter_stability_wedge_instability_lobe."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'hyper_parameter_stability_wedge_instability_lobe'
