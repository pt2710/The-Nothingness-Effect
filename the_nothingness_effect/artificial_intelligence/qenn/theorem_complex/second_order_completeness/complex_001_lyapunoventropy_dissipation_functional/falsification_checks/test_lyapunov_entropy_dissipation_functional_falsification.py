"""Fail-closed falsification metadata check for lyapunov_entropy_dissipation_functional."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'lyapunov_entropy_dissipation_functional'
