"""Fail-closed falsification metadata check for parity_resolved_autocorrelation_operator."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'parity_resolved_autocorrelation_operator'
