"""Fail-closed falsification metadata check for entropic_hyperparameter_stability_margin."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'entropic_hyperparameter_stability_margin'
