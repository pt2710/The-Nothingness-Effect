"""Fail-closed falsification metadata check for lyapunov_parseval_training_isometry_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'lyapunov_parseval_training_isometry_closure'
