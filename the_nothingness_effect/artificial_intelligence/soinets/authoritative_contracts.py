"""Source-faithful SOInet theorem/failure dual and product certificates."""
...
IMPLEMENTATION_PATH = "the_nothingness_effect/artificial_intelligence/soinets/authoritative_contracts.py"
...
def _source_law(index: int, value: base.SOInetContractInput):
...
def contracts():
    return build_contracts(
        ...
        input_type=base.SOInetContractInput,
        input_name="SOInet modality theorem/failure field",
        input_description="finite typed modality-by-space-by-feature carrier",
        source_ids=A_IDS,
        b_ids=B_IDS,
        c_ids=C_IDS,
        ...
        artifact_spec=ArtifactSpec(
            ...
            "python -m the_nothingness_effect.artificial_intelligence.soinets.simulation.run_contract_suite",
        ),
    )
