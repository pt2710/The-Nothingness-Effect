"""Fail-closed falsification metadata check for motif_spectral_dual_regularity_law_for_soinets."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'motif_spectral_dual_regularity_law_for_soinets'
