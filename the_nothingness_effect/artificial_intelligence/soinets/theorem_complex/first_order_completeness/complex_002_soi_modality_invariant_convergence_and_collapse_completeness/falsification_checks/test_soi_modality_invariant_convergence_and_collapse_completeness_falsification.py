"""Fail-closed falsification metadata check for soi_modality_invariant_convergence_and_collapse_completeness."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'soi_modality_invariant_convergence_and_collapse_completeness'
