"""Fail-closed falsification metadata check for soinet_cross_modal_transfer_generalization_and_dual_stability."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'soinet_cross_modal_transfer_generalization_and_dual_stability'
