"""Fail-closed falsification metadata check for soinet_error_contraction_and_dual_error_orthogonality."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'soinet_error_contraction_and_dual_error_orthogonality'
