"""Fail-closed falsification metadata check for universal_entropy_minimization_and_collapse_degeneracy_duality_in_soinet."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'universal_entropy_minimization_and_collapse_degeneracy_duality_in_soinet'
