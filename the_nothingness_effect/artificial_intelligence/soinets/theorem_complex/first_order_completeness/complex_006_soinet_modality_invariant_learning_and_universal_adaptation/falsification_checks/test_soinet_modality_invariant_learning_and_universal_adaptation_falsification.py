"""Fail-closed falsification metadata check for soinet_modality_invariant_learning_and_universal_adaptation."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'soinet_modality_invariant_learning_and_universal_adaptation'
