"""Fail-closed falsification metadata check for soinet_universal_expressivity_bound_entropy_minimal_generalization_principle."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'soinet_universal_expressivity_bound_entropy_minimal_generalization_principle'
