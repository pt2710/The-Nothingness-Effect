"""Fail-closed falsification metadata check for soinet_cross_modal_compositionality_modality_invariant_collapse_principle."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'soinet_cross_modal_compositionality_modality_invariant_collapse_principle'
