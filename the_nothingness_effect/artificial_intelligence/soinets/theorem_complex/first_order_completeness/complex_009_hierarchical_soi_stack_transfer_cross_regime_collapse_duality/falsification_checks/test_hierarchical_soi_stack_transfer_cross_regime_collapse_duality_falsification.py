"""Fail-closed falsification metadata check for hierarchical_soi_stack_transfer_cross_regime_collapse_duality."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'hierarchical_soi_stack_transfer_cross_regime_collapse_duality'
