"""Fail-closed falsification metadata check for soinet_universal_generalization_principle_failure_brittleness_duality."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'soinet_universal_generalization_principle_failure_brittleness_duality'
