"""Fail-closed falsification metadata check for soinet_universal_cloning_principle_cloning_failure_duality."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'soinet_universal_cloning_principle_cloning_failure_duality'
