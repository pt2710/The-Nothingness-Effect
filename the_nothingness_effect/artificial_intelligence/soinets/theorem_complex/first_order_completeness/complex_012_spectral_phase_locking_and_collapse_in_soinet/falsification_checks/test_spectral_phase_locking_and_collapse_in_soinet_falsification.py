"""Fail-closed falsification metadata check for spectral_phase_locking_and_collapse_in_soinet."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'spectral_phase_locking_and_collapse_in_soinet'
