"""Fail-closed falsification metadata check for soi_cross_domain_generalization_and_collapse."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'soi_cross_domain_generalization_and_collapse'
