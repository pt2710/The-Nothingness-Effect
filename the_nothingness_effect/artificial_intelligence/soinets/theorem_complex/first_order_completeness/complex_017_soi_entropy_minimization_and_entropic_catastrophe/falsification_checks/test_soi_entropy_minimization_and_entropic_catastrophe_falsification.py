"""Fail-closed falsification metadata check for soi_entropy_minimization_and_entropic_catastrophe."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'soi_entropy_minimization_and_entropic_catastrophe'
