"""Fail-closed falsification metadata check for cross_modal_generalization_collapse_transfer."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'cross_modal_generalization_collapse_transfer'
