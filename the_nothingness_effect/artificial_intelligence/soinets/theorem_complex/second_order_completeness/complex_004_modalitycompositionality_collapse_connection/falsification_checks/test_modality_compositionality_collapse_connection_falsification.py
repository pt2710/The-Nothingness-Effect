"""Fail-closed falsification metadata check for modality_compositionality_collapse_connection."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'modality_compositionality_collapse_connection'
