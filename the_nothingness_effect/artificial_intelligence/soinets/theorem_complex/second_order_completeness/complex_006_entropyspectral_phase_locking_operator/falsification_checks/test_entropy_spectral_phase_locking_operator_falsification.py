"""Fail-closed falsification metadata check for entropy_spectral_phase_locking_operator."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'entropy_spectral_phase_locking_operator'
