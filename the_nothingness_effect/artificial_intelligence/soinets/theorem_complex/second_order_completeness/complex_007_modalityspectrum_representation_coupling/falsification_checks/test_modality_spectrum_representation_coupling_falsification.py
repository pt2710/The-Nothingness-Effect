"""Fail-closed falsification metadata check for modality_spectrum_representation_coupling."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'modality_spectrum_representation_coupling'
