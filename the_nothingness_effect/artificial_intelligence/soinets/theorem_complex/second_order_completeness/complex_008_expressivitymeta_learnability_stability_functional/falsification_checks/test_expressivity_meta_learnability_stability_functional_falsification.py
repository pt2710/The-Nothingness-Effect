"""Fail-closed falsification metadata check for expressivity_meta_learnability_stability_functional."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'expressivity_meta_learnability_stability_functional'
