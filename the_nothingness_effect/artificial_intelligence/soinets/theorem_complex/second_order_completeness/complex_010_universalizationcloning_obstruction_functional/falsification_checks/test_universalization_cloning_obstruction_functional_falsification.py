"""Fail-closed falsification metadata check for universalization_cloning_obstruction_functional."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'universalization_cloning_obstruction_functional'
