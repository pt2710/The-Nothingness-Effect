"""Fail-closed falsification metadata check for motif_spectral_modality_collapse_spatial_field."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'motif_spectral_modality_collapse_spatial_field'
