"""Fail-closed falsification metadata check for cross_modal_compositional_spatial_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'cross_modal_compositional_spatial_closure'
