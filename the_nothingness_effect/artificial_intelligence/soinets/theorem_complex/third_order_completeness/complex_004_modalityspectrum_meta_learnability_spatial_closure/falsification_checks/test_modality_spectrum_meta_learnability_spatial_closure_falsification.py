"""Fail-closed falsification metadata check for modality_spectrum_meta_learnability_spatial_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'modality_spectrum_meta_learnability_spatial_closure'
