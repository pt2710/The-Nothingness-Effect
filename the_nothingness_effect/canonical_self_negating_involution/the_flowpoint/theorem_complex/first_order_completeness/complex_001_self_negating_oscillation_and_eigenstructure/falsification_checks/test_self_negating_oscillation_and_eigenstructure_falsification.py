"""Fail-closed falsification metadata check for self_negating_oscillation_and_eigenstructure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'self_negating_oscillation_and_eigenstructure'
