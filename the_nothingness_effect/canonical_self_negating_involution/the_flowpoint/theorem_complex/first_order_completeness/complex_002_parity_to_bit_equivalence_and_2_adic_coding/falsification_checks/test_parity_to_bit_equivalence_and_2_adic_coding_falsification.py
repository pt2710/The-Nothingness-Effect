"""Fail-closed falsification metadata check for parity_to_bit_equivalence_and_2_adic_coding."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'parity_to_bit_equivalence_and_2_adic_coding'
