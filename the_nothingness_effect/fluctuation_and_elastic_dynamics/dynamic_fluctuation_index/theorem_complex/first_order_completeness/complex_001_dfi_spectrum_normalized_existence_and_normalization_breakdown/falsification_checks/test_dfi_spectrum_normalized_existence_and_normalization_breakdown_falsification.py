"""Fail-closed falsification metadata check for dfi_spectrum_normalized_existence_and_normalization_breakdown."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dfi_spectrum_normalized_existence_and_normalization_breakdown'
