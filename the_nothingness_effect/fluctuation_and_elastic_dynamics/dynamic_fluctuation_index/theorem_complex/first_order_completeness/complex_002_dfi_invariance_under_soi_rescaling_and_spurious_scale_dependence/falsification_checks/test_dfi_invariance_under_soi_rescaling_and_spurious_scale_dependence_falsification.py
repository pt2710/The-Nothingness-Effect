"""Fail-closed falsification metadata check for dfi_invariance_under_soi_rescaling_and_spurious_scale_dependence."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dfi_invariance_under_soi_rescaling_and_spurious_scale_dependence'
