"""Fail-closed falsification metadata check for dfi_adaptive_applicability_and_contextual_instability."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dfi_adaptive_applicability_and_contextual_instability'
