"""Fail-closed falsification metadata check for dfi_uniqueness_of_decomposition_and_mapping_ambiguity."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dfi_uniqueness_of_decomposition_and_mapping_ambiguity'
