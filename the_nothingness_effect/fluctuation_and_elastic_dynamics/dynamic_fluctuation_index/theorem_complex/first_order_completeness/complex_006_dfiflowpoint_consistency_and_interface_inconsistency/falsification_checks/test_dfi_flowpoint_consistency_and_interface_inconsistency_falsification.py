"""Fail-closed falsification metadata check for dfi_flowpoint_consistency_and_interface_inconsistency."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dfi_flowpoint_consistency_and_interface_inconsistency'
