"""Fail-closed falsification metadata check for dfi_simulation_consistency_and_simulation_breakdown."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dfi_simulation_consistency_and_simulation_breakdown'
