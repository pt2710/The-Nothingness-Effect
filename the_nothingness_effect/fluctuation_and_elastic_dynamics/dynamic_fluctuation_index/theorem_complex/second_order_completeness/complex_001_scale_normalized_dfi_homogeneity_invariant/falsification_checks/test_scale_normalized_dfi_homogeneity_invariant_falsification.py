"""Fail-closed falsification metadata check for scale_normalized_dfi_homogeneity_invariant."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'scale_normalized_dfi_homogeneity_invariant'
