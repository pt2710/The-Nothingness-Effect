"""Fail-closed falsification metadata check for entropic_applicability_response_operator."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'entropic_applicability_response_operator'
