"""Fail-closed falsification metadata check for flowpoint_certified_dfi_validation_functional."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'flowpoint_certified_dfi_validation_functional'
