"""Fail-closed falsification metadata check for elastic_e_curvature_encoding_and_curvature_ambiguity_divergence."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_e_curvature_encoding_and_curvature_ambiguity_divergence'
