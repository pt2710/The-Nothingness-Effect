"""Fail-closed falsification metadata check for elastic_curvature_entropy_duality_and_decoupling."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_curvature_entropy_duality_and_decoupling'
