"""Fail-closed falsification metadata check for elastic_simulation_consistency_and_simulation_breakdown_non_equivalence."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_simulation_consistency_and_simulation_breakdown_non_equivalence'
