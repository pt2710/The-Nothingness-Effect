"""Fail-closed falsification metadata check for curvature_certified_simulation_residual."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'curvature_certified_simulation_residual'
