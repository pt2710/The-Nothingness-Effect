"""Fail-closed falsification metadata check for spatial_reciprocal_curvature_validation_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'spatial_reciprocal_curvature_validation_closure'
