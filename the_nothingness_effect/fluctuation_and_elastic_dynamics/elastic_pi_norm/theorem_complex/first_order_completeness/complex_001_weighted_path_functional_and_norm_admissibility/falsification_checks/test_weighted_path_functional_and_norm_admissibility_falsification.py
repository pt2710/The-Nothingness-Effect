"""Fail-closed falsification metadata check for weighted_path_functional_and_norm_admissibility."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'weighted_path_functional_and_norm_admissibility'
