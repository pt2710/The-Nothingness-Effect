"""Fail-closed falsification metadata check for elastic_field_ratios_and_weight_regularity."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_field_ratios_and_weight_regularity'
