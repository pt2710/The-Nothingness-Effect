"""Fail-closed falsification metadata check for weighted_path_ratio_regularity_functional."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'weighted_path_ratio_regularity_functional'
