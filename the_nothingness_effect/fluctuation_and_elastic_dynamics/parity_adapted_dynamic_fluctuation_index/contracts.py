...
def contracts() -> tuple[ComplexContract, ...]:
    ...
    artifact = ArtifactSpec(("transition_csv", "parity_plot", "source_removal_table"), "python -m the_nothingness_effect.fluctuation_and_elastic_dynamics.parity_adapted_dynamic_fluctuation_index.simulation.run_contract_suite")
    a_specs = (
