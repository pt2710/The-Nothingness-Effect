"""Fail-closed falsification metadata check for flowpoint_parity_correspondence_and_decoupling."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'flowpoint_parity_correspondence_and_decoupling'
