"""Fail-closed falsification metadata check for pdfi_entropic_predictability_and_fluctuation_ambiguity."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'pdfi_entropic_predictability_and_fluctuation_ambiguity'
