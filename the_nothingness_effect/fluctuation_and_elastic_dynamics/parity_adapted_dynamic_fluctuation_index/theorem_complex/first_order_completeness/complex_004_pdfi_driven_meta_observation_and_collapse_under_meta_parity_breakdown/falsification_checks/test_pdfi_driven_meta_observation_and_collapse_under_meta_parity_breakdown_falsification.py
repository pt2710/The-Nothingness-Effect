"""Fail-closed falsification metadata check for pdfi_driven_meta_observation_and_collapse_under_meta_parity_breakdown."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'pdfi_driven_meta_observation_and_collapse_under_meta_parity_breakdown'
