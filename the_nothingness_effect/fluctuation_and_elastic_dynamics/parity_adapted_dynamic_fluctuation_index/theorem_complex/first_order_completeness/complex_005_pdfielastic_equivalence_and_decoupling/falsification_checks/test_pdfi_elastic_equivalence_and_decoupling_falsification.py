"""Fail-closed falsification metadata check for pdfi_elastic_equivalence_and_decoupling."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'pdfi_elastic_equivalence_and_decoupling'
