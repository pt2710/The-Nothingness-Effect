"""Fail-closed falsification metadata check for predictability_observation_parity_coupling."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'predictability_observation_parity_coupling'
