"""Fail-closed falsification metadata check for elastic_calibration_completeness_functional."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_calibration_completeness_functional'
