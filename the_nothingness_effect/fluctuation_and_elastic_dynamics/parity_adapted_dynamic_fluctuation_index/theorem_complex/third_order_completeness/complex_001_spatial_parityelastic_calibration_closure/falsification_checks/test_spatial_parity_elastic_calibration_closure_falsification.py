"""Fail-closed falsification metadata check for spatial_parity_elastic_calibration_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'spatial_parity_elastic_calibration_closure'
