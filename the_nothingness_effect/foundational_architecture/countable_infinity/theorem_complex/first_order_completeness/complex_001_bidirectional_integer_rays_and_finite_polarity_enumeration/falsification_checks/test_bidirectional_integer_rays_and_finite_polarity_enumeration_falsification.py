"""Fail-closed falsification metadata check for bidirectional_integer_rays_and_finite_polarity_enumeration."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'bidirectional_integer_rays_and_finite_polarity_enumeration'
