"""Fail-closed falsification metadata check for combinatorial_cubic_generation_and_stochastic_polarity_accessibility."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'combinatorial_cubic_generation_and_stochastic_polarity_accessibility'
