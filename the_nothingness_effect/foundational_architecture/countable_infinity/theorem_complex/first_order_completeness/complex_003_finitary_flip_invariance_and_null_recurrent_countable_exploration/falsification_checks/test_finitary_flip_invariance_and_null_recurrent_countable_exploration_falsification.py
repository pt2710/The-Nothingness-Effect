"""Fail-closed falsification metadata check for finitary_flip_invariance_and_null_recurrent_countable_exploration."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'finitary_flip_invariance_and_null_recurrent_countable_exploration'
