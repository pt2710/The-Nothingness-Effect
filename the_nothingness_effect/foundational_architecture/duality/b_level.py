...
def contracts() -> tuple[ComplexContract, ...]:
    return (
        ComplexContract(
            ...
            artifact_spec=ArtifactSpec(("cover_table", "source_ablation", "operator_diagram"), "python -m the_nothingness_effect.foundational_architecture.duality.simulation"),
            implementation_path="the_nothingness_effect/foundational_architecture/duality/b_level.py",
        ),
        ComplexContract(
            ...
            artifact_spec=ArtifactSpec(("pair_table", "source_ablation", "operator_diagram"), "python -m the_nothingness_effect.foundational_architecture.duality.simulation"),
            implementation_path="the_nothingness_effect/foundational_architecture/duality/b_level.py",
        ),
    )
