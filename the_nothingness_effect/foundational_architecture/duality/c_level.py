...
def contracts() -> tuple[ComplexContract, ...]:
    return (
        ComplexContract(
            ...
            artifact_spec=ArtifactSpec(("field_csv", "boundary_plot", "animation_generator", "bundle_diagram"), "python -m the_nothingness_effect.foundational_architecture.duality.simulation"),
            implementation_path="the_nothingness_effect/foundational_architecture/duality/c_level.py",
        ),
    )
