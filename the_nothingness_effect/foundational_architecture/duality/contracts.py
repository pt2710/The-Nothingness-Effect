...
from the_nothingness_effect._runtime.theorem_complex_runtime import ComplexContract, TheoremComplexRegistry
...
def duality_contracts() -> tuple[ComplexContract, ...]:
    return a_contracts() + b_contracts() + c_contracts()


def registered_duality_registry(
    ...
    for contract in duality_contracts():
