"""Fail-closed falsification metadata check for minimal_two_state_involution_orbitwise_alternator."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'minimal_two_state_involution_orbitwise_alternator'
