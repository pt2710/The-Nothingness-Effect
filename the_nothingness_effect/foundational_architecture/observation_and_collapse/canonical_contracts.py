...
def contracts() -> tuple[ComplexContract, ...]:
    return (
        _contract(
            ...
            MeanErgodicInput,
            MeanErgodicLaw,
            mean_ergodic_collapse,
            (
                "operator_involution_residual",
                "fixed_residual",
        ...
        _contract(
            ...
            AttractorLaw,
            attractor_stability,
            ("zero_mean_residual", "attractor_residual", "stability_bound_residual"),
        ),
        _contract(
            A3,
            ComplexLevel.A,
            ...
            ("pathwise_residual", "singleton_residual", "ensemble_residual"),
        ),
        _contract(
            A4,
            ComplexLevel.A,
        ...
        _contract(
            ...
            closure_consistency,
            (
                "monotonicity_residual",
                "extensivity_residual",
                "idempotence_residual",
                "output_fixed_residual",
            ),
        ),
        _contract(
            A6,
            ...
            ("output_fixed_residual", "eventual_idempotence_residual", "partition_residual"),
        ),
        _contract(
            A7,
            ComplexLevel.A,
        ...
        _contract(
            ...
            (),
            MeanErgodicInput,
            ErgodicProjectionLaw,
            ergodic_projection,
            (
                "involution_residual",
                "idempotence_residual",
                "fixed_range_residual",
                "orthogonality_residual",
                "convergence_residual",
            ),
        ),
        _contract(
            ...
            (remove_b1_closure, remove_b1_instrument),
        ),
        _contract(
            B2,
            ComplexLevel.B,
            ...
            (remove_b2_projection, remove_b2_ergodic, remove_b2_definiteness),
        ),
        _contract(
            B3,
            ComplexLevel.B,
            ...
            TemporalCompressionLaw,
            temporal_compression,
            (
                "convergence_residual",
                "common_limit_residual",
                "compression_residual",
                "cauchy_residual",
            ),
            (remove_b3_convergence, remove_b3_stability, _remove_temporal_uniqueness),
        ),
        _contract(
            B4,
            ComplexLevel.B,
            (A4, A8, A6),
            SpectralCollapseInput,
            SpectralSelectionLaw,
            spectral_selection,
            (
                "projection_residual",
                "selection_residual",
                "multiplier_residual",
                "preparation_residual",
            ),
            (remove_b4_projection, remove_b4_ergodic, remove_b4_definiteness),
        ),
        _contract(
            C1,
            ComplexLevel.C,
            ...
            (
                lambda value: remove_c1(value, B2, "pinning"),
                lambda value: remove_c1(value, B4, "selection"),
            ),
            closed=True,
        ),
        _contract(
            ...
            (
                lambda value: remove_c2(value, B3, "temporal"),
                lambda value: remove_c2(value, B4, "spectral"),
            ),
            closed=True,
        ),
        _contract(
            ...
            HorizonLaw,
            local_horizon,
            ("tail_residual", "tightness_residual", "horizon_residual", "leakage_residual"),
            (
                lambda value: remove_c3(value, B3, "temporal"),
                lambda value: remove_c3(value, B4, "spectral"),
            ),
            closed=True,
        ),
        _contract(
            ...
            OutcomeFieldInput,
            OutcomeFieldLaw,
            closure_conditioned_outcome_field,
            (
                "commutator_residual",
                "orthogonality_residual",
            ...
            (
                lambda value: remove_c4(value, B1, "closure"),
                lambda value: remove_c4(value, B2, "pinning"),
                lambda value: remove_c4(value, B4, "selection"),
            ),
            closed=True,
        ),
    )
