"""Fail-closed falsification metadata check for observation_induced_collapse_and_collapse_divergence."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'observation_induced_collapse_and_collapse_divergence'
