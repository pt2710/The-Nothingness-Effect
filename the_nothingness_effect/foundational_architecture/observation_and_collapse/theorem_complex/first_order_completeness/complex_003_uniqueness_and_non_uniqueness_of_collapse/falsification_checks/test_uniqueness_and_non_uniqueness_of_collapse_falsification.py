"""Fail-closed falsification metadata check for uniqueness_and_non_uniqueness_of_collapse."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'uniqueness_and_non_uniqueness_of_collapse'
