"""Fail-closed falsification metadata check for hilbert_projection_realization_and_projection_breakdown."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'hilbert_projection_realization_and_projection_breakdown'
