"""Fail-closed falsification metadata check for fixed_point_consistency_and_trivial_collapse_failure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'fixed_point_consistency_and_trivial_collapse_failure'
