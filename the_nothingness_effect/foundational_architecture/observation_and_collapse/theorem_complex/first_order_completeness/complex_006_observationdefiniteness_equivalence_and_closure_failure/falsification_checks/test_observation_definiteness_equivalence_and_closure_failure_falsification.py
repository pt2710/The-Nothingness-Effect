"""Fail-closed falsification metadata check for observation_definiteness_equivalence_and_closure_failure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'observation_definiteness_equivalence_and_closure_failure'
