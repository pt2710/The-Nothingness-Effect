"""Fail-closed falsification metadata check for definite_state_projection_and_state_ambiguity."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'definite_state_projection_and_state_ambiguity'
