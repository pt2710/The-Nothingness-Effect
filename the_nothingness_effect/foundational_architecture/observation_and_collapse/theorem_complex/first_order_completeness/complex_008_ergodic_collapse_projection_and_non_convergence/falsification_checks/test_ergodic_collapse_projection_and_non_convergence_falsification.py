"""Fail-closed falsification metadata check for ergodic_collapse_projection_and_non_convergence."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'ergodic_collapse_projection_and_non_convergence'
