"""Fail-closed falsification metadata check for involutive_collapse_spectral_pinning_and_spectral_drift."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'involutive_collapse_spectral_pinning_and_spectral_drift'
