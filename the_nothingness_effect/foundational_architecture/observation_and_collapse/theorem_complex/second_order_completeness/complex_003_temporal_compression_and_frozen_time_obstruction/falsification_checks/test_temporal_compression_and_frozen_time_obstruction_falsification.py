"""Fail-closed falsification metadata check for temporal_compression_and_frozen_time_obstruction."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'temporal_compression_and_frozen_time_obstruction'
