"""Fail-closed falsification metadata check for collapse_spectral_selection_and_spectral_ambiguity."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'collapse_spectral_selection_and_spectral_ambiguity'
