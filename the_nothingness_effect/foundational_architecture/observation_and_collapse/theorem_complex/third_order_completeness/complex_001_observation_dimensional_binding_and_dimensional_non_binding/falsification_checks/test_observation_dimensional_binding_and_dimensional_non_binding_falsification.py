"""Fail-closed falsification metadata check for observation_dimensional_binding_and_dimensional_non_binding."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'observation_dimensional_binding_and_dimensional_non_binding'
