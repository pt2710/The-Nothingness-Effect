"""Fail-closed falsification metadata check for observable_locality_and_collapse_inaccessibility."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'observable_locality_and_collapse_inaccessibility'
