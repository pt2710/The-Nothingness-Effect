"""Fail-closed falsification metadata check for local_horizon_boundary_and_non_locality_divergence."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'local_horizon_boundary_and_non_locality_divergence'
