"""Fail-closed falsification metadata check for closure_conditioned_spectral_outcome_field."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'closure_conditioned_spectral_outcome_field'
