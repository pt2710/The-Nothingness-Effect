"""Fail-closed falsification metadata check for minimal_and_cyclic_spatiality_two_state_reflection_and_finite_cyclic_orbit_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'minimal_and_cyclic_spatiality_two_state_reflection_and_finite_cyclic_orbit_closure'
