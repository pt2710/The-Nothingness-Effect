"""Fail-closed falsification metadata check for cyclic_square_root_lifting_and_phase_anchored_dihedralization."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'cyclic_square_root_lifting_and_phase_anchored_dihedralization'
