"""Fail-closed falsification metadata check for equivariant_orbit_spectral_reconstruction."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'equivariant_orbit_spectral_reconstruction'
