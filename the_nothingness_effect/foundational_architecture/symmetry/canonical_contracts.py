"""Canonical Symmetry contract registry with recertified source identifiers.
...
long-form Duality compatibility identifier to the active canonical A-contract
...
_SOURCE_ID_ALIASES = {
    "involutive_duality_c_2_action_equivalence_and_free_presentation": (
