"""Fail-closed falsification metadata check for bidirectional_orbit_invariance_and_minimal_involution_generated_c_2_action."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'bidirectional_orbit_invariance_and_minimal_involution_generated_c_2_action'
