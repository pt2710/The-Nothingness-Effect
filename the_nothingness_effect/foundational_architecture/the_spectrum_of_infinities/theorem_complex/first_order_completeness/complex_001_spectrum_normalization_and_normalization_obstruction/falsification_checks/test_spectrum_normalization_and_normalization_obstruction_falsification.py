"""Fail-closed falsification metadata check for spectrum_normalization_and_normalization_obstruction."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'spectrum_normalization_and_normalization_obstruction'
