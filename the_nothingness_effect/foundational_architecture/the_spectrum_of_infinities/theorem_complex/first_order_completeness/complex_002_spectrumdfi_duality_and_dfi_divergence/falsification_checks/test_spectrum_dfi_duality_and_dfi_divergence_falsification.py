"""Fail-closed falsification metadata check for spectrum_dfi_duality_and_dfi_divergence."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'spectrum_dfi_duality_and_dfi_divergence'
