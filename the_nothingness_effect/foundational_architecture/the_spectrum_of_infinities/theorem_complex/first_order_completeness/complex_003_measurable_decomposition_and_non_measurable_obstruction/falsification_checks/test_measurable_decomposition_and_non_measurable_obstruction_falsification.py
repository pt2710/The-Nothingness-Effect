"""Fail-closed falsification metadata check for measurable_decomposition_and_non_measurable_obstruction."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'measurable_decomposition_and_non_measurable_obstruction'
