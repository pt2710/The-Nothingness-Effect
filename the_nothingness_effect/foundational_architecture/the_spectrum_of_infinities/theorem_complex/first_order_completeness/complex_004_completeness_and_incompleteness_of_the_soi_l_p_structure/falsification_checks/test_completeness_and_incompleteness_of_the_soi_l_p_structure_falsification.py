"""Fail-closed falsification metadata check for completeness_and_incompleteness_of_the_soi_l_p_structure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'completeness_and_incompleteness_of_the_soi_l_p_structure'
