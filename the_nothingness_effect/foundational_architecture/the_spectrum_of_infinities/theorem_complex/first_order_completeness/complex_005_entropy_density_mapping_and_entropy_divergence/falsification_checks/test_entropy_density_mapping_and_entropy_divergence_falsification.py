"""Fail-closed falsification metadata check for entropy_density_mapping_and_entropy_divergence."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'entropy_density_mapping_and_entropy_divergence'
