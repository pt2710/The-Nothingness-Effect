"""Fail-closed falsification metadata check for finitizable_infinity_and_the_non_finitization_boundary."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'finitizable_infinity_and_the_non_finitization_boundary'
