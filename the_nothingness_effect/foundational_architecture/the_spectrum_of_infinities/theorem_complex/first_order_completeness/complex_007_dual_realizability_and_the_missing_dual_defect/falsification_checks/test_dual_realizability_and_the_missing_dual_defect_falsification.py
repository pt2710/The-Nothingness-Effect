"""Fail-closed falsification metadata check for dual_realizability_and_the_missing_dual_defect."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dual_realizability_and_the_missing_dual_defect'
