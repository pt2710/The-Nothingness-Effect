"""Fail-closed falsification metadata check for soi_measure_preserving_normalization_and_spectrum_obstruction."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'soi_measure_preserving_normalization_and_spectrum_obstruction'
