"""Fail-closed falsification metadata check for borel_analytic_sufficiency_and_over_extension_beyond_measurability."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'borel_analytic_sufficiency_and_over_extension_beyond_measurability'
