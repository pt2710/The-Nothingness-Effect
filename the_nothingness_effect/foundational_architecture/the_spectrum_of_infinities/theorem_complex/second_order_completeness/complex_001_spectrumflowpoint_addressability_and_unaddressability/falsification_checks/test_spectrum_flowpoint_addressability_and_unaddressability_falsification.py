"""Fail-closed falsification metadata check for spectrum_flowpoint_addressability_and_unaddressability."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'spectrum_flowpoint_addressability_and_unaddressability'
