"""Fail-closed falsification metadata check for 2_adic_history_accessibility_and_frozen_accessibility."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == '2_adic_history_accessibility_and_frozen_accessibility'
