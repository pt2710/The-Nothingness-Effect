"""Fail-closed falsification metadata check for cosmic_matrix_address_and_ghost_spark_obstruction."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'cosmic_matrix_address_and_ghost_spark_obstruction'
