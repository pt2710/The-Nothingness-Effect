"""Fail-closed falsification metadata check for observable_locality_and_infinite_exposure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'observable_locality_and_infinite_exposure'
