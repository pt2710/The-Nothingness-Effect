"""Fail-closed falsification metadata check for elastic_curvature_probing_and_incoherent_warping."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_curvature_probing_and_incoherent_warping'
