"""Fail-closed falsification metadata check for continuum_trajectory_cardinality_and_countable_phase_cell_collapse."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'continuum_trajectory_cardinality_and_countable_phase_cell_collapse'
