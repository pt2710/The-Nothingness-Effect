"""Fail-closed falsification metadata check for power_set_continuum_and_atomic_quotient_collapse."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'power_set_continuum_and_atomic_quotient_collapse'
