"""Fail-closed falsification metadata check for dense_flowpoint_traces_and_nowhere_dense_quantized_collapse."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dense_flowpoint_traces_and_nowhere_dense_quantized_collapse'
