"""Fail-closed falsification metadata check for recursive_cantor_space_universality_and_finite_resolution_collapse."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'recursive_cantor_space_universality_and_finite_resolution_collapse'
