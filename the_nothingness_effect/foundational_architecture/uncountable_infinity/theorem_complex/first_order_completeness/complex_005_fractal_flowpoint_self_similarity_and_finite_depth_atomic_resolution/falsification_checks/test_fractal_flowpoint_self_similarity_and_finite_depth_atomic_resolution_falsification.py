"""Fail-closed falsification metadata check for fractal_flowpoint_self_similarity_and_finite_depth_atomic_resolution."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'fractal_flowpoint_self_similarity_and_finite_depth_atomic_resolution'
