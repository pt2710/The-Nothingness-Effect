"""Fail-closed falsification metadata check for complete_boolean_algebra_missing_complements_and_generated_completion."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'complete_boolean_algebra_missing_complements_and_generated_completion'
