"""Fail-closed falsification metadata check for operational_coarse_graining_and_persistence_of_unresolved_distinctions."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'operational_coarse_graining_and_persistence_of_unresolved_distinctions'
