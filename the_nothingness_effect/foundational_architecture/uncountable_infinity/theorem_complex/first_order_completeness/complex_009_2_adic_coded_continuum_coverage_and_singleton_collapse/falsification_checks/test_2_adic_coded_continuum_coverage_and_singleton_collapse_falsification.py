"""Fail-closed falsification metadata check for 2_adic_coded_continuum_coverage_and_singleton_collapse."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == '2_adic_coded_continuum_coverage_and_singleton_collapse'
