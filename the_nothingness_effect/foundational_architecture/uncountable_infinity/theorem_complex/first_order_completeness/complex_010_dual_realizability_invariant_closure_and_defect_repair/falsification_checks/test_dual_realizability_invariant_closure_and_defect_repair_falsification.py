"""Fail-closed falsification metadata check for dual_realizability_invariant_closure_and_defect_repair."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dual_realizability_invariant_closure_and_defect_repair'
