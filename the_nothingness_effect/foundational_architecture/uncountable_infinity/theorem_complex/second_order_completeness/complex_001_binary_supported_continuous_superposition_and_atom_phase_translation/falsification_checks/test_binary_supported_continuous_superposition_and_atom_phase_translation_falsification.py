"""Fail-closed falsification metadata check for binary_supported_continuous_superposition_and_atom_phase_translation."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'binary_supported_continuous_superposition_and_atom_phase_translation'
