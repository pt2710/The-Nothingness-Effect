"""Fail-closed falsification metadata check for complement_invariant_fractal_skeleton_completion."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'complement_invariant_fractal_skeleton_completion'
