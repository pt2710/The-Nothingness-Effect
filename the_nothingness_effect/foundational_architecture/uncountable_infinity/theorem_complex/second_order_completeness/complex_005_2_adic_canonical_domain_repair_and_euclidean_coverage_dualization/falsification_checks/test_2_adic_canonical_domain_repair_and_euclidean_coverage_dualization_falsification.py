"""Fail-closed falsification metadata check for 2_adic_canonical_domain_repair_and_euclidean_coverage_dualization."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == '2_adic_canonical_domain_repair_and_euclidean_coverage_dualization'
