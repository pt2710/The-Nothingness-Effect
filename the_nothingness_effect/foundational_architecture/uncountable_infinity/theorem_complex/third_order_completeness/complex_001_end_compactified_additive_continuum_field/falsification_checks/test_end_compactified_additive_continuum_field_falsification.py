"""Fail-closed falsification metadata check for end_compactified_additive_continuum_field."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'end_compactified_additive_continuum_field'
