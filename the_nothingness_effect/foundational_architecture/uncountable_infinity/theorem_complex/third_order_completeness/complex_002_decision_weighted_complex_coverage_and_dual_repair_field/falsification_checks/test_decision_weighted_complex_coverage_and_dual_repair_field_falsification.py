"""Fail-closed falsification metadata check for decision_weighted_complex_coverage_and_dual_repair_field."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'decision_weighted_complex_coverage_and_dual_repair_field'
