"""Fail-closed falsification metadata check for black_hole_dynamics::elastic_black_hole_emergence_triviality_of_breakdown."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'black_hole_dynamics::elastic_black_hole_emergence_triviality_of_breakdown'
