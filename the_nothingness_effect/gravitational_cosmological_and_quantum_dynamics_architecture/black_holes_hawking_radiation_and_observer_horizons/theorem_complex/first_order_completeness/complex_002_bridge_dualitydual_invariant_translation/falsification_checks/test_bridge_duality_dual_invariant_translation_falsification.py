"""Fail-closed falsification metadata check for bridge_duality_dual_invariant_translation."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'bridge_duality_dual_invariant_translation'
