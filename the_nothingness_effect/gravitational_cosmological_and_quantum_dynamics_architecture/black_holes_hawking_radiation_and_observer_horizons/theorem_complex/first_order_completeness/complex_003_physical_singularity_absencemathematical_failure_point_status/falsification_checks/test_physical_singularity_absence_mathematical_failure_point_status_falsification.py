"""Fail-closed falsification metadata check for physical_singularity_absence_mathematical_failure_point_status."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'physical_singularity_absence_mathematical_failure_point_status'
