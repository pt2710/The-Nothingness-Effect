"""Fail-closed falsification metadata check for black_hole_observability_triviality_and_regularity."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'black_hole_observability_triviality_and_regularity'
