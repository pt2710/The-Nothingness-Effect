"""Fail-closed falsification metadata check for elastic_hawking_emission_radiative_stasis."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_hawking_emission_radiative_stasis'
