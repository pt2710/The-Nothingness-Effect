"""Fail-closed falsification metadata check for hawking_radiation_as_entropic_relaxation_stasis."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'hawking_radiation_as_entropic_relaxation_stasis'
