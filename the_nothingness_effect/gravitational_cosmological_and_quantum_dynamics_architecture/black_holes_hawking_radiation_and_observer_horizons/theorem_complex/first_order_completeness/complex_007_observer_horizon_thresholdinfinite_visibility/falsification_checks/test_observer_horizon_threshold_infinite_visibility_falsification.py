"""Fail-closed falsification metadata check for observer_horizon_threshold_infinite_visibility."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'observer_horizon_threshold_infinite_visibility'
