"""Fail-closed falsification metadata check for black_hole_dynamics::elastic_gravitational_memory_instant_relaxation."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'black_hole_dynamics::elastic_gravitational_memory_instant_relaxation'
