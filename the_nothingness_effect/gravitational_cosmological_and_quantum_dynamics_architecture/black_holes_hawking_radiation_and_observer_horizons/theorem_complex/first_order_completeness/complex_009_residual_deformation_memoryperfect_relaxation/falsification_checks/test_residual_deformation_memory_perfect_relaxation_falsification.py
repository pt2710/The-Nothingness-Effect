"""Fail-closed falsification metadata check for residual_deformation_memory_perfect_relaxation."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'residual_deformation_memory_perfect_relaxation'
