"""Fail-closed falsification metadata check for simulation_consistency_breakdown_and_non_equivalence."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'simulation_consistency_breakdown_and_non_equivalence'
