"""Fail-closed falsification metadata check for regular_nonperforating_horizon_geometry."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'regular_nonperforating_horizon_geometry'
