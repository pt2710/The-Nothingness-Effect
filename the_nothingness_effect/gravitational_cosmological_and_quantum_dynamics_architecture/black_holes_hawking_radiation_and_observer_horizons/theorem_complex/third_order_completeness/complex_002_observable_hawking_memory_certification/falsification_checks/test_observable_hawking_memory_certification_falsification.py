"""Fail-closed falsification metadata check for observable_hawking_memory_certification."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'observable_hawking_memory_certification'
