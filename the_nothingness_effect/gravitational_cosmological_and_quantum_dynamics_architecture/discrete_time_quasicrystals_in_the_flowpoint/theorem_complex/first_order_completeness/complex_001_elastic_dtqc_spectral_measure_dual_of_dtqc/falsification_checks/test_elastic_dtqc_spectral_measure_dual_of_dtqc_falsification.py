"""Fail-closed falsification metadata check for elastic_dtqc_spectral_measure_dual_of_dtqc."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_dtqc_spectral_measure_dual_of_dtqc'
