"""Fail-closed falsification metadata check for dtqc::dual_support_equivalence_support_mismatch_leakage."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dtqc::dual_support_equivalence_support_mismatch_leakage'
