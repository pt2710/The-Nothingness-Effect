"""Fail-closed falsification metadata check for parseval_energy_bijection_l_2_energy_mismatch."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'parseval_energy_bijection_l_2_energy_mismatch'
