"""Fail-closed falsification metadata check for irrational_drive_locking_commensurate_resonance_collapse."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'irrational_drive_locking_commensurate_resonance_collapse'
