"""Fail-closed falsification metadata check for meyer_cut_and_project_structure_non_meyer_diffuse_support."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'meyer_cut_and_project_structure_non_meyer_diffuse_support'
