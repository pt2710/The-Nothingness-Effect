"""Fail-closed falsification metadata check for z_2_2_sign_symmetry_parity_bias_symmetry_breaking."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'z_2_2_sign_symmetry_parity_bias_symmetry_breaking'
