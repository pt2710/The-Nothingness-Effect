"""Fail-closed falsification metadata check for elastic_invariance_of_support_nonlinear_leakage."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_invariance_of_support_nonlinear_leakage'
