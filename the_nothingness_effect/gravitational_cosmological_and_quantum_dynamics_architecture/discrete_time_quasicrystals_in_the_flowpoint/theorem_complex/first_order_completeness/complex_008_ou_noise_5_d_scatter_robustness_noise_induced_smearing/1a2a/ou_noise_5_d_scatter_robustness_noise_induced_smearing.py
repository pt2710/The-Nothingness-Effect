...
COMPONENT = TheoremComponent(
    ...
    equation_labels=('eq:dtqc08_typed_ou_process', 'eq:dtqc08_five_dimensional_feature', 'eq:dtqc08_joint_status_1a2a', 'eq:dtqc_model_1a2a', 'eq:ou_ar1_observation_1a2a', 'eq:ou_spectrum_discrete_1a2a', 'eq:windowed_spectrum_def_1a2a', 'eq:expected_periodogram_decomp_1a2a', 'eq:ou_autocorr_ct_1a2a', 'eq:ou_spectrum_ct_1a2a', 'eq:ct_expected_spectrum_decomp_1a2a', 'eq:threshold_equivalence_def_1a2a', 'eq:fwhm_partition_1a2a', 'eq:design_criterion_1a2a'),
