"""Fail-closed falsification metadata check for ou_noise_5_d_scatter_robustness_noise_induced_smearing."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'ou_noise_5_d_scatter_robustness_noise_induced_smearing'
