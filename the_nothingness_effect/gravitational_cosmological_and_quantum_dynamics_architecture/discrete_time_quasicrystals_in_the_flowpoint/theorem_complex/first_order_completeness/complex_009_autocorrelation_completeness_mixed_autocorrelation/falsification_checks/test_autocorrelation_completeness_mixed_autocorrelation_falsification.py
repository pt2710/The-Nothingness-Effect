"""Fail-closed falsification metadata check for autocorrelation_completeness_mixed_autocorrelation."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'autocorrelation_completeness_mixed_autocorrelation'
