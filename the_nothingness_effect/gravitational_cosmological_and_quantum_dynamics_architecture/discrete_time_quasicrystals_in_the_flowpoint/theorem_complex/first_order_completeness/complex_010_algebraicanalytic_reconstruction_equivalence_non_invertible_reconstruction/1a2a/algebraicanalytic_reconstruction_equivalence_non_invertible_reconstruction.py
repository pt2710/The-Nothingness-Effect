...
COMPONENT = TheoremComponent(
    ...
    equation_labels=('eq:dtqc10_typed_l1_fourier_pair', 'eq:dtqc10_joint_status_1a2a', 'eq:q_support_def_1a2a', 'eq:time_series_def_1a2a', 'eq:spectral_measure_def_1a2a', 'eq:forward_map_1a2a', 'eq:inverse_map_1a2a', 'eq:mean_energy_limit_1a2a', 'eq:parseval_pp_1a2a', 'eq:stability_series_1a2a', 'eq:stability_measure_1a2a', 'eq:round_trip_equivalences_1a2a', 'eq:compression_certificate_1a2a'),
