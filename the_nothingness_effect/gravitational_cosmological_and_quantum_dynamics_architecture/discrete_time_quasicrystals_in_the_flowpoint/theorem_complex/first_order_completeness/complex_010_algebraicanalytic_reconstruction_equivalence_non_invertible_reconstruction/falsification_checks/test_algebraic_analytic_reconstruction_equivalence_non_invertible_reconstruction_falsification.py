"""Fail-closed falsification metadata check for algebraic_analytic_reconstruction_equivalence_non_invertible_reconstruction."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'algebraic_analytic_reconstruction_equivalence_non_invertible_reconstruction'
