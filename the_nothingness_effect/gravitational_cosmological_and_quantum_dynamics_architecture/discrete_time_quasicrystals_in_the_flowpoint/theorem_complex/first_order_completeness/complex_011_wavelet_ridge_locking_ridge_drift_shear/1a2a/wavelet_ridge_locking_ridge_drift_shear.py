...
COMPONENT = TheoremComponent(
    ...
    equation_labels=('eq:dtqc11_joint_status_1a2a', 'eq:qp_rep_1a2a', 'eq:cwt_def_1a2a', 'eq:ridge_def_1a2a', 'eq:ridge_lock_freq_1a2a', 'eq:ridge_bias_bound_1a2a', 'eq:cwt_sp_1a2a', 'eq:stationary_a_1a2a', 'eq:drift_linear_bound_1a2a', 'eq:geodesic_curvature_1a2a', 'eq:ridge_chain_rule_1a2a', 'eq:ridge_shear_curvature_1a2a', 'eq:fft_cwt_consistency_1a2a'),
