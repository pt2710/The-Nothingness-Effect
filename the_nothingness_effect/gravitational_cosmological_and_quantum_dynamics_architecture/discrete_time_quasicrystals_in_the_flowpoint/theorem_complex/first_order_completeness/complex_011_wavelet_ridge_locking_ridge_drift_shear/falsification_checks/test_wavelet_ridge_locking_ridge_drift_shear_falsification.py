"""Fail-closed falsification metadata check for wavelet_ridge_locking_ridge_drift_shear."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'wavelet_ridge_locking_ridge_drift_shear'
