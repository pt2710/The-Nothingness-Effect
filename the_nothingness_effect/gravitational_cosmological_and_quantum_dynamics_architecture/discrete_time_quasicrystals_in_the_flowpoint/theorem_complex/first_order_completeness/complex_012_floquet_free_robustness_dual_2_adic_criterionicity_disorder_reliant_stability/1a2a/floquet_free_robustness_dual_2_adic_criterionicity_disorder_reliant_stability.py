...
COMPONENT = TheoremComponent(
    ...
    equation_labels=('eq:dtqc12_typed_disorder_coupling', 'eq:dtqc12_joint_status_1a2a', 'eq:coeff_def_floquet_free_1a2a', 'eq:spec_measure_def_floquet_free_1a2a', 'eq:two_adic_criterionicity_floquet_free_1a2a', 'eq:energy_mismatch_floquet_free_1a2a', 'eq:parseval_and_stationarity_floquet_free_1a2a', 'eq:joint_equivalence_1a2a', 'eq:intrinsic_case_1a2a', 'eq:disorder_case_1a2a'),
