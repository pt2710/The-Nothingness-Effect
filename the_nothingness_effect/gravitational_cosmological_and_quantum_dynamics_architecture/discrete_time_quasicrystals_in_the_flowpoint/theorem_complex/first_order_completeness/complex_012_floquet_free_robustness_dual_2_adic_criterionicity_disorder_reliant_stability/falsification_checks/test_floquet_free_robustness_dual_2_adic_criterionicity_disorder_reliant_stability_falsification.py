"""Fail-closed falsification metadata check for floquet_free_robustness_dual_2_adic_criterionicity_disorder_reliant_stability."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'floquet_free_robustness_dual_2_adic_criterionicity_disorder_reliant_stability'
