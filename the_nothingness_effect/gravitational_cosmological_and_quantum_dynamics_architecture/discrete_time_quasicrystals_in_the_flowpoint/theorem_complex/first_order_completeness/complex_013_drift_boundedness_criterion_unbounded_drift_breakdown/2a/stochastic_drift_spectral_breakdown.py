'Authoritative theorem title: Stochastic-Drift Spectral Breakdown (2A).'
...
COMPONENT = TheoremComponent(
    ...
    authoritative_title='Stochastic-Drift Spectral Breakdown',
    authoritative_title_tex='Stochastic-Drift Spectral Breakdown (2A)',
