"""Fail-closed falsification metadata check for drift_boundedness_criterion_unbounded_drift_breakdown."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'drift_boundedness_criterion_unbounded_drift_breakdown'
