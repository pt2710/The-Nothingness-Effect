"""Fail-closed falsification metadata check for dfi_compatible_tail_control_tail_driven_mass_imbalance."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dfi_compatible_tail_control_tail_driven_mass_imbalance'
