"""Fail-closed falsification metadata check for figure_backed_closure_bragg_cwt_figure_contradicted_claims."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'figure_backed_closure_bragg_cwt_figure_contradicted_claims'
