"""Fail-closed falsification metadata check for elastic_gain_support_transport_isomorphism."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_gain_support_transport_isomorphism'
