"""Fail-closed falsification metadata check for autocorrelation_reconstruction_projector."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'autocorrelation_reconstruction_projector'
