"""Fail-closed falsification metadata check for ridge_resolved_2_adic_robustness_certificate."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'ridge_resolved_2_adic_robustness_certificate'
