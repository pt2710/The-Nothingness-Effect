"""Fail-closed falsification metadata check for drift_tail_figure_certification_functional."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'drift_tail_figure_certification_functional'
