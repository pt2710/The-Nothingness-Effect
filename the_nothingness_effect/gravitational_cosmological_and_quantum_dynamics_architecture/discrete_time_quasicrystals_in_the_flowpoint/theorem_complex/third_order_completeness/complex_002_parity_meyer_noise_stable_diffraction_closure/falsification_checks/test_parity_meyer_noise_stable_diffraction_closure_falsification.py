"""Fail-closed falsification metadata check for parity_meyer_noise_stable_diffraction_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'parity_meyer_noise_stable_diffraction_closure'
