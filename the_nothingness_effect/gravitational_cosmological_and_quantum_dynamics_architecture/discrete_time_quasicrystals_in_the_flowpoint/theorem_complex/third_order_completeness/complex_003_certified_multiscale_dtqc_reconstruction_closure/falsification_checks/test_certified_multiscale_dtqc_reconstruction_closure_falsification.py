"""Fail-closed falsification metadata check for certified_multiscale_dtqc_reconstruction_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'certified_multiscale_dtqc_reconstruction_closure'
