"""Fail-closed falsification metadata check for elastic_dubler_curvature_correspondence."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_dubler_curvature_correspondence'
