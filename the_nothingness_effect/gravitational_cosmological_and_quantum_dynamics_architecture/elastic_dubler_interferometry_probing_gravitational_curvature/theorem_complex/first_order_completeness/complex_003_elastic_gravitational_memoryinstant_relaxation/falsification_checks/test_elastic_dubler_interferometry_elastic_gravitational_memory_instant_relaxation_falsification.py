"""Fail-closed falsification metadata check for elastic_dubler_interferometry::elastic_gravitational_memory_instant_relaxation."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_dubler_interferometry::elastic_gravitational_memory_instant_relaxation'
