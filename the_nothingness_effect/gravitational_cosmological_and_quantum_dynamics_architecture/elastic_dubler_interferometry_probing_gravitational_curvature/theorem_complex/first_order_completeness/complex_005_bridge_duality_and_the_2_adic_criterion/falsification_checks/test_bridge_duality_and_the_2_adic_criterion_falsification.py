"""Fail-closed falsification metadata check for bridge_duality_and_the_2_adic_criterion."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'bridge_duality_and_the_2_adic_criterion'
