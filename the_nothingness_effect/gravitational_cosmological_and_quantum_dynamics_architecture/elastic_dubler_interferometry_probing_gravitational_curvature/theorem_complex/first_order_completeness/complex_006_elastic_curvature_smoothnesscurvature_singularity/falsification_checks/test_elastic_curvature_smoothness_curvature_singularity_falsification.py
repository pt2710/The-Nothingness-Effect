"""Fail-closed falsification metadata check for elastic_curvature_smoothness_curvature_singularity."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_curvature_smoothness_curvature_singularity'
