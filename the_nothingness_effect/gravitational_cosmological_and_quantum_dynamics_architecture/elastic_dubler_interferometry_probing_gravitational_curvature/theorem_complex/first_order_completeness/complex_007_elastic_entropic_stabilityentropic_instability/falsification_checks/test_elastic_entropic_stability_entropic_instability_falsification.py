"""Fail-closed falsification metadata check for elastic_entropic_stability_entropic_instability."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_entropic_stability_entropic_instability'
