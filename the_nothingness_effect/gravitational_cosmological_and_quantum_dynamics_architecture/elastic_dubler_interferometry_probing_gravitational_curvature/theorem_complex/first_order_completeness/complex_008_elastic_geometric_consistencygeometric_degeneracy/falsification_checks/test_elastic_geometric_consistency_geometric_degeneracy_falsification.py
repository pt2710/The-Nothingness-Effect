"""Fail-closed falsification metadata check for elastic_geometric_consistency_geometric_degeneracy."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_geometric_consistency_geometric_degeneracy'
