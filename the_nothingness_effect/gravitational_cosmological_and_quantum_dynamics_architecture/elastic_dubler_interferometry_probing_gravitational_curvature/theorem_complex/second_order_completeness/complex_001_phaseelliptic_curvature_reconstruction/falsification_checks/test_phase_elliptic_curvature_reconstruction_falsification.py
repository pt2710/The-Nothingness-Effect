"""Fail-closed falsification metadata check for phase_elliptic_curvature_reconstruction."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'phase_elliptic_curvature_reconstruction'
