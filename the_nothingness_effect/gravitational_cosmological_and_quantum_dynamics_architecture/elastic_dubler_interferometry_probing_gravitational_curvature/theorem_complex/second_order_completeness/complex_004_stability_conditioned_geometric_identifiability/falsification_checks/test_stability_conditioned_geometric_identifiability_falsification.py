"""Fail-closed falsification metadata check for stability_conditioned_geometric_identifiability."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'stability_conditioned_geometric_identifiability'
