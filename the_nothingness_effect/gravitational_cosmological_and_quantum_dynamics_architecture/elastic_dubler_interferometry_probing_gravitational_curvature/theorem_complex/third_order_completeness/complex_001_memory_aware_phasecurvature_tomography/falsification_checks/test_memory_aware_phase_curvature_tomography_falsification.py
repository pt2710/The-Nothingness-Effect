"""Fail-closed falsification metadata check for memory_aware_phase_curvature_tomography."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'memory_aware_phase_curvature_tomography'
