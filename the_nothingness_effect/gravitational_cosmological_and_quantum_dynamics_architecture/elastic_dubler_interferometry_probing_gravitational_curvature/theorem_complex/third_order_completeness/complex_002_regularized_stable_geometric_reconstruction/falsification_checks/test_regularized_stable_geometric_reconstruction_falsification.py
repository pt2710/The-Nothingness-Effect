"""Fail-closed falsification metadata check for regularized_stable_geometric_reconstruction."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'regularized_stable_geometric_reconstruction'
