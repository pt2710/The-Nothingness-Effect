"""Fail-closed falsification metadata check for cosmic_spark_flowpoint_correspondence_and_spectral_duality."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'cosmic_spark_flowpoint_correspondence_and_spectral_duality'
