"""Fail-closed falsification metadata check for cosmic_spark_decay_and_integrated_cosmological_memory."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'cosmic_spark_decay_and_integrated_cosmological_memory'
