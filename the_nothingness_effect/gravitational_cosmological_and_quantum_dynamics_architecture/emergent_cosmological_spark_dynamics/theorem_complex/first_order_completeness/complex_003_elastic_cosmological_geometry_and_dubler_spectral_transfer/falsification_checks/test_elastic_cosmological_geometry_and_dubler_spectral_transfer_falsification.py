"""Fail-closed falsification metadata check for elastic_cosmological_geometry_and_dubler_spectral_transfer."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_cosmological_geometry_and_dubler_spectral_transfer'
