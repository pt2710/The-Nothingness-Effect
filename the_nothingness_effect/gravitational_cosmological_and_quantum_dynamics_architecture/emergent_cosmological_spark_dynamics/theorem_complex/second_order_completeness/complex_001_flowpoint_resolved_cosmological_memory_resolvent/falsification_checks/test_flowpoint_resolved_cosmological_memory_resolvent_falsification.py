"""Fail-closed falsification metadata check for flowpoint_resolved_cosmological_memory_resolvent."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'flowpoint_resolved_cosmological_memory_resolvent'
