"""Fail-closed falsification metadata check for horizon_localized_observable_memory_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'horizon_localized_observable_memory_closure'
