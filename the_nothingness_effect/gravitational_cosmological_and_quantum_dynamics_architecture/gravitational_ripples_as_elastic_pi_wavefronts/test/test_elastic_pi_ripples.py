...
from the_nothingness_effect.gravitational_cosmological_and_quantum_dynamics_architecture.gravitational_ripples_as_elastic_pi_wavefronts.elastic_pi_ripples import (
    RippleParams,
...
def _write_test_artifacts() -> dict[str, Path]:
    ...
    ax.legend()
    figure = SCRIPT_DIR / "artifacts" / "elastic_pi_ripples_test_visualization.png"
    data = SCRIPT_DIR / "artifacts" / "elastic_pi_ripples_test_data.npz"
    results = SCRIPT_DIR / "artifacts" / "elastic_pi_ripples_test_results.csv"
