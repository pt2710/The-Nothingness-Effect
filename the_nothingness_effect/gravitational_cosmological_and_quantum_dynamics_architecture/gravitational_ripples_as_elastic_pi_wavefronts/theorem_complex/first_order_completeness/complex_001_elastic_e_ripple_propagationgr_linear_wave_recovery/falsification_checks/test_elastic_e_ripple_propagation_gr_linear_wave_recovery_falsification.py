"""Fail-closed falsification metadata check for elastic_e_ripple_propagation_gr_linear_wave_recovery."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_e_ripple_propagation_gr_linear_wave_recovery'
