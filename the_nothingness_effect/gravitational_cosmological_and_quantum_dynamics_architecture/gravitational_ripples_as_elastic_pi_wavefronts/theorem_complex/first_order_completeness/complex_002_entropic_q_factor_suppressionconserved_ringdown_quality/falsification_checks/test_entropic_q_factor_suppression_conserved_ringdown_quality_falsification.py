"""Fail-closed falsification metadata check for entropic_q_factor_suppression_conserved_ringdown_quality."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'entropic_q_factor_suppression_conserved_ringdown_quality'
