"""Fail-closed falsification metadata check for nonlinear_overtone_generation_spectral_purity."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'nonlinear_overtone_generation_spectral_purity'
