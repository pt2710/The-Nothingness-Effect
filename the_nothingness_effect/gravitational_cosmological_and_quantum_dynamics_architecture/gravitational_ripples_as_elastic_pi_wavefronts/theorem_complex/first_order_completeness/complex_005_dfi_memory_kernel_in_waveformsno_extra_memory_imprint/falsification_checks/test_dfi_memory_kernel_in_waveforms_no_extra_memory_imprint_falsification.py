"""Fail-closed falsification metadata check for dfi_memory_kernel_in_waveforms_no_extra_memory_imprint."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dfi_memory_kernel_in_waveforms_no_extra_memory_imprint'
