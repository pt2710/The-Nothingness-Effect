"""Fail-closed falsification metadata check for flowpoint_boundary_mode_conversion_pure_mode_propagation."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'flowpoint_boundary_mode_conversion_pure_mode_propagation'
