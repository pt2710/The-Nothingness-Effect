"""Fail-closed falsification metadata check for shock_onset_self_steepening_threshold_no_shock_propagation."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'shock_onset_self_steepening_threshold_no_shock_propagation'
