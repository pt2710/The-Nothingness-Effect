"""Fail-closed falsification metadata check for stochastic_background_tilt_n_e_standard_gr_tilt_n_t."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'stochastic_background_tilt_n_e_standard_gr_tilt_n_t'
