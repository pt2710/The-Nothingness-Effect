"""Fail-closed falsification metadata check for environment_dependent_group_velocity_mapping_uniform_propagation."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'environment_dependent_group_velocity_mapping_uniform_propagation'
