"""Fail-closed falsification metadata check for invertible_source_transport_detection_map_non_invertible_degeneracy."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'invertible_source_transport_detection_map_non_invertible_degeneracy'
