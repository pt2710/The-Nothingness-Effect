"""Fail-closed falsification metadata check for environment_tomography_information_metric."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'environment_tomography_information_metric'
