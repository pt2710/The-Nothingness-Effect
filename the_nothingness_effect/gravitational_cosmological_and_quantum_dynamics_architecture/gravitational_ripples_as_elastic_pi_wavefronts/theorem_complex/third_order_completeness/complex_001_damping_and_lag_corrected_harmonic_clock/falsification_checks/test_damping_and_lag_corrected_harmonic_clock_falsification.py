"""Fail-closed falsification metadata check for damping_and_lag_corrected_harmonic_clock."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'damping_and_lag_corrected_harmonic_clock'
