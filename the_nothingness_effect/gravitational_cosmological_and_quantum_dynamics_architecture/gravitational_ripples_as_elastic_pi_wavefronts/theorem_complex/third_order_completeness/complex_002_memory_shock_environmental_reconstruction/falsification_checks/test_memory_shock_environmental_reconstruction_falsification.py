"""Fail-closed falsification metadata check for memory_shock_environmental_reconstruction."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'memory_shock_environmental_reconstruction'
