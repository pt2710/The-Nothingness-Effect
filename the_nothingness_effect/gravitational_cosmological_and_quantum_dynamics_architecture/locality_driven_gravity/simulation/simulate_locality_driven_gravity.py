...
from the_nothingness_effect._runtime.artifacts.io import CLAIM_BOUNDARY, ensure_dir, save_csv, save_figure, save_json, save_npz, write_metadata
...
def run(
    ...
    metadata_payload = {
        ...
        "script": "the_nothingness_effect.gravitational_cosmological_and_quantum_dynamics_architecture.locality_driven_gravity.simulation.simulate_locality_driven_gravity",
        "equations_module": "the_nothingness_effect.gravitational_cosmological_and_quantum_dynamics_architecture.locality_driven_gravity.entropic_elastic_spiral",
