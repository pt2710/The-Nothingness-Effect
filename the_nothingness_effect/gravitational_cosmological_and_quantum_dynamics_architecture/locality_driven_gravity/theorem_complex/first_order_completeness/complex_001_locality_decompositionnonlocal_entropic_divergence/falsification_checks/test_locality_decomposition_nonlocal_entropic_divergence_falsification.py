"""Fail-closed falsification metadata check for locality_decomposition_nonlocal_entropic_divergence."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'locality_decomposition_nonlocal_entropic_divergence'
