"""Fail-closed falsification metadata check for emergent_spiral_density_wave_spiral_dissolution."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'emergent_spiral_density_wave_spiral_dissolution'
