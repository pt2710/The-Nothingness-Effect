"""Fail-closed falsification metadata check for entropic_curvature_superposition_duality."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'entropic_curvature_superposition_duality'
