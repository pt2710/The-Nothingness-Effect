"""Fail-closed falsification metadata check for locality_driven_gravity::elastic_entropic_energy_equivalence."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'locality_driven_gravity::elastic_entropic_energy_equivalence'
