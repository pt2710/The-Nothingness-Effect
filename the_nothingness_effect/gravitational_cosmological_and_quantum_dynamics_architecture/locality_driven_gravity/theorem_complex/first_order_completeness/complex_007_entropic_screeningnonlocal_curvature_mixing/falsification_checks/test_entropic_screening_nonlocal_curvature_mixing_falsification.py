"""Fail-closed falsification metadata check for entropic_screening_nonlocal_curvature_mixing."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'entropic_screening_nonlocal_curvature_mixing'
