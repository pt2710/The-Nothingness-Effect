"""Fail-closed falsification metadata check for entropic_gradient_filament_formation_duality."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'entropic_gradient_filament_formation_duality'
