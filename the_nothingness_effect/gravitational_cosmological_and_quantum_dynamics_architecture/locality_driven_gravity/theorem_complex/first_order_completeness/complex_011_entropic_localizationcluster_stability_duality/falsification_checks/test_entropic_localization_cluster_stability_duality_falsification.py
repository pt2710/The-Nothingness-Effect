"""Fail-closed falsification metadata check for entropic_localization_cluster_stability_duality."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'entropic_localization_cluster_stability_duality'
