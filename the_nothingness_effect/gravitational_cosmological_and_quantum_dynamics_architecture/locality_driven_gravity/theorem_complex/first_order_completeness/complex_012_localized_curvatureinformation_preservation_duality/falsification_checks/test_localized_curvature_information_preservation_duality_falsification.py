"""Fail-closed falsification metadata check for localized_curvature_information_preservation_duality."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'localized_curvature_information_preservation_duality'
