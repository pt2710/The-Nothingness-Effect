"""Fail-closed falsification metadata check for cosmic_web_emergence_homogenization_duality."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'cosmic_web_emergence_homogenization_duality'
