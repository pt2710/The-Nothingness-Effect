"""Fail-closed falsification metadata check for curvature_driven_elastic_energy_production."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'curvature_driven_elastic_energy_production'
