"""Fail-closed falsification metadata check for information_bearing_cluster_web_stability."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'information_bearing_cluster_web_stability'
