"""Fail-closed falsification metadata check for information_preserving_cosmic_network_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'information_preserving_cosmic_network_closure'
