"""Fail-closed falsification metadata check for elastic_dubler_pdfi_frequency_shift_dual_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_dubler_pdfi_frequency_shift_dual_closure'
