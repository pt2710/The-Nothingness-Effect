"""Fail-closed falsification metadata check for elastic_dubler_effect::elastic_entropic_energy_equivalence."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_dubler_effect::elastic_entropic_energy_equivalence'
