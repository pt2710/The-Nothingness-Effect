"""Fail-closed falsification metadata check for locality_nonlocality_in_the_dubler_pdfi_framework."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'locality_nonlocality_in_the_dubler_pdfi_framework'
