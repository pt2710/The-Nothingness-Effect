"""Fail-closed falsification metadata check for spectral_observability_indistinguishability."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'spectral_observability_indistinguishability'
