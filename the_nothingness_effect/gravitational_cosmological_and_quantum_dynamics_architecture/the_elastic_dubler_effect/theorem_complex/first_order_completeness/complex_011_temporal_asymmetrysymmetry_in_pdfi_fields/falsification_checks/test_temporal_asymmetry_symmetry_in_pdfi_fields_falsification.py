"""Fail-closed falsification metadata check for temporal_asymmetry_symmetry_in_pdfi_fields."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'temporal_asymmetry_symmetry_in_pdfi_fields'
