"""Fail-closed falsification metadata check for causality_via_elastic_dubler_e_and_causal_symmetry."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'causality_via_elastic_dubler_e_and_causal_symmetry'
