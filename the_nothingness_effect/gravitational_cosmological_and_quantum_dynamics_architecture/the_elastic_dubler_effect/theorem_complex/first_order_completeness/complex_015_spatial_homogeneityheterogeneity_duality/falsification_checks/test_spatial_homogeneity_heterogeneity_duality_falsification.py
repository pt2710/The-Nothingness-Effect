"""Fail-closed falsification metadata check for spatial_homogeneity_heterogeneity_duality."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'spatial_homogeneity_heterogeneity_duality'
