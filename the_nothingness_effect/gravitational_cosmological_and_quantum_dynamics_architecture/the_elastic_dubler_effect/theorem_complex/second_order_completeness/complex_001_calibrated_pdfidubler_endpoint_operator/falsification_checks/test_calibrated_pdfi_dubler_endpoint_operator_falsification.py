"""Fail-closed falsification metadata check for calibrated_pdfi_dubler_endpoint_operator."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'calibrated_pdfi_dubler_endpoint_operator'
