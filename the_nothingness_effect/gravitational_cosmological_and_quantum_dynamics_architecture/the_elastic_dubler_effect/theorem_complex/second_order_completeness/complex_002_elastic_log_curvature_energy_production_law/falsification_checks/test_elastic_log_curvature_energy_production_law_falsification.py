"""Fail-closed falsification metadata check for elastic_log_curvature_energy_production_law."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elastic_log_curvature_energy_production_law'
