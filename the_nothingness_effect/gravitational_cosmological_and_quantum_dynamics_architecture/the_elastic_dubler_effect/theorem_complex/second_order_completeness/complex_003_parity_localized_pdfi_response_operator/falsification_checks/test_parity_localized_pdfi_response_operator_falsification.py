"""Fail-closed falsification metadata check for parity_localized_pdfi_response_operator."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'parity_localized_pdfi_response_operator'
