"""Fail-closed falsification metadata check for elasticity_scaled_spectral_operator_flow."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elasticity_scaled_spectral_operator_flow'
