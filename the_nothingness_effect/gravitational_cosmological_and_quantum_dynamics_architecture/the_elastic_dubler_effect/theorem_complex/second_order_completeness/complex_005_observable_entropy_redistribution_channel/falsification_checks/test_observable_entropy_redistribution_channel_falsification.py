"""Fail-closed falsification metadata check for observable_entropy_redistribution_channel."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'observable_entropy_redistribution_channel'
