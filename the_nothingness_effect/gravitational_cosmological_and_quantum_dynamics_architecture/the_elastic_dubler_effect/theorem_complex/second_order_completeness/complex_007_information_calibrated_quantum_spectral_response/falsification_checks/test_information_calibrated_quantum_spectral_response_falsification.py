"""Fail-closed falsification metadata check for information_calibrated_quantum_spectral_response."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'information_calibrated_quantum_spectral_response'
