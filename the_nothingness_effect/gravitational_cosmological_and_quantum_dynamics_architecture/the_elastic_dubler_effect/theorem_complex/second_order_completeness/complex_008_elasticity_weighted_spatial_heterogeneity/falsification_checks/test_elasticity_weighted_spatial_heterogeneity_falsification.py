"""Fail-closed falsification metadata check for elasticity_weighted_spatial_heterogeneity."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'elasticity_weighted_spatial_heterogeneity'
