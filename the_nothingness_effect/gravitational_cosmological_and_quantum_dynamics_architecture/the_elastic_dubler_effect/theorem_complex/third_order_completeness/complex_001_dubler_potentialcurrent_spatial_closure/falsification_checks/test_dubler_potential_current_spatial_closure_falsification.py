"""Fail-closed falsification metadata check for dubler_potential_current_spatial_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dubler_potential_current_spatial_closure'
