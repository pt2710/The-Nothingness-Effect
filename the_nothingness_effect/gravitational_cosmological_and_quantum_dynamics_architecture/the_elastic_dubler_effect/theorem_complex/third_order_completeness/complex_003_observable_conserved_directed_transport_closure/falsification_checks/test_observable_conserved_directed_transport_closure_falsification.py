"""Fail-closed falsification metadata check for observable_conserved_directed_transport_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'observable_conserved_directed_transport_closure'
