"""Fail-closed falsification metadata check for spatially_calibrated_quantum_information_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'spatially_calibrated_quantum_information_closure'
