...
def contracts() -> tuple[ComplexContract, ...]:
    return (
        ComplexContract(
            ...
            artifact_spec=ArtifactSpec(("field_csv", "boundary_plot", "animation_generator", "operator_diagram"), "python -m the_nothingness_effect.mathematical_architecture.simulation"),
