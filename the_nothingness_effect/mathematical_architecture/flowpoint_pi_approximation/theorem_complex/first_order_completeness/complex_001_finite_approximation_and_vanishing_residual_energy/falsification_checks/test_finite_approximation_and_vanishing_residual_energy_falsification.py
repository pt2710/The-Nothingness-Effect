"""Fail-closed falsification metadata check for finite_approximation_and_vanishing_residual_energy."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'finite_approximation_and_vanishing_residual_energy'
