"""Fail-closed falsification metadata check for complex_phase_coordinates_and_fourier_reconstruction."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'complex_phase_coordinates_and_fourier_reconstruction'
