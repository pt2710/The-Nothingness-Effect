"""Fail-closed falsification metadata check for flowpoint_unity_orientation_and_integer_unfolding."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'flowpoint_unity_orientation_and_integer_unfolding'
