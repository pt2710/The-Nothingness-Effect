"""Fail-closed falsification metadata check for addition_of_arithmetic_orientation_and_typed_operation_theory."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'addition_of_arithmetic_orientation_and_typed_operation_theory'
