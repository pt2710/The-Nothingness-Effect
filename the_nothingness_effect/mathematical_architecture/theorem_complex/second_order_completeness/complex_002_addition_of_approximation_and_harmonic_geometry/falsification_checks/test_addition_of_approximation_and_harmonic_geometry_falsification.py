"""Fail-closed falsification metadata check for addition_of_approximation_and_harmonic_geometry."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'addition_of_approximation_and_harmonic_geometry'
