"""Fail-closed falsification metadata check for addition_of_the_two_complete_b_level_operator_families."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'addition_of_the_two_complete_b_level_operator_families'
