"""Fail-closed falsification metadata check for global_symmetry_and_kd_charge_conservation."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'global_symmetry_and_kd_charge_conservation'
