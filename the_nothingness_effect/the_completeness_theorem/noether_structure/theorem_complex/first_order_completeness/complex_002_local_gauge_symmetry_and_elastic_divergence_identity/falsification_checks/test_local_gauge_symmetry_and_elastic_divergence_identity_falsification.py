"""Fail-closed falsification metadata check for local_gauge_symmetry_and_elastic_divergence_identity."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'local_gauge_symmetry_and_elastic_divergence_identity'
