"""Fail-closed falsification metadata check for noether_constant_to_local_transgression."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'noether_constant_to_local_transgression'
