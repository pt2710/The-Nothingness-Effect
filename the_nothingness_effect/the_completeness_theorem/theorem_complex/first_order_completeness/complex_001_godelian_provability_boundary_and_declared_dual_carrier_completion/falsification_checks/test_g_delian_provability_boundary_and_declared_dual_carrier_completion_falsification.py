"""Fail-closed falsification metadata check for g_delian_provability_boundary_and_declared_dual_carrier_completion."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'g_delian_provability_boundary_and_declared_dual_carrier_completion'
