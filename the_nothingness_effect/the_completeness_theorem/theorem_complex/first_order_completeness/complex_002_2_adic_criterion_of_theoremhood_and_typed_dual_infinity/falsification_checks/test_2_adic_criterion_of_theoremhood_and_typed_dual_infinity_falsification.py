"""Fail-closed falsification metadata check for 2_adic_criterion_of_theoremhood_and_typed_dual_infinity."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == '2_adic_criterion_of_theoremhood_and_typed_dual_infinity'
