"""Fail-closed falsification metadata check for dual_closure_idempotence_and_oscillatory_non_closure."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'dual_closure_idempotence_and_oscillatory_non_closure'
