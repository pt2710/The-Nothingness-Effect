"""Fail-closed falsification metadata check for karoubi_envelope_equivalence_and_missing_idempotent_splittings."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'karoubi_envelope_equivalence_and_missing_idempotent_splittings'
