"""Fail-closed falsification metadata check for commutation_of_closure_with_parity_soi_and_misaligned_closures."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'commutation_of_closure_with_parity_soi_and_misaligned_closures'
