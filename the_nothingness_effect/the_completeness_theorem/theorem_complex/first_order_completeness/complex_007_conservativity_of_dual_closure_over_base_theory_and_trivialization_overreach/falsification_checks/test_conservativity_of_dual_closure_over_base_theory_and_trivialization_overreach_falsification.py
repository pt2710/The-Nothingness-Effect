"""Fail-closed falsification metadata check for conservativity_of_dual_closure_over_base_theory_and_trivialization_overreach."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'conservativity_of_dual_closure_over_base_theory_and_trivialization_overreach'
