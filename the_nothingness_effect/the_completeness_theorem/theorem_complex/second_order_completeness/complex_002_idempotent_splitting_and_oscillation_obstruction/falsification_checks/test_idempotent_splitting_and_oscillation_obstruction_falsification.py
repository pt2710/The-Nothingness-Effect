"""Fail-closed falsification metadata check for idempotent_splitting_and_oscillation_obstruction."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'idempotent_splitting_and_oscillation_obstruction'
