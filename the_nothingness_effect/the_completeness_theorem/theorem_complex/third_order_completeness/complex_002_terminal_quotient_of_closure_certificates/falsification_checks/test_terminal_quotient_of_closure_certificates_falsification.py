"""Fail-closed falsification metadata check for terminal_quotient_of_closure_certificates."""
...
def test_falsification_obligations_are_explicit():
    ...
    assert manifest["complex_id"] == 'terminal_quotient_of_closure_certificates'
